...
int main()
{
	/*
	// curl test.
	std::string url = "https://jethro-yang.github.io/project-wing-webserver/config.json";
	std::string response = CCURL::GetInstance()->SendRequest(
		url
		, CCURL::GetInstance()->METHOD_GET);
